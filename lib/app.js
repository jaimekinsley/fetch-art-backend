...
//   try {
//     const data = await request.get(`https://api.unsplash.com/search/photos/?query=happy&client_id=${process.env.UNSPLASH_KEY}`);

//     const mungedData = mungedDetail(data.body);
